...
CKEDITOR.editorConfig = function( config ) {
    ...
    config.toolbar = 'osaSimple';
    config.toolbar_osaSimple =
    [
      { name: 's1', items: [ 'Undo', 'Redo' ] },
      { name: 's2', items: [ 'Bold', 'Italic', 'Underline', 'Strike', 'TextColor', 'BGColor' ] },
      { name: 's3', items: [ 'NumberedList', 'BulletedList', 'Outdent','Indent' ] },
      { name: 's4', items: [ 'RemoveFormat', 'PasteText', 'PasteFromWord', 'Table' ] },
      { name: 's5', items: [ 'Source' ] },
    ];
